...
const EMPTY: BudgetPayload = {
  ...
  // its own sentence above. (Which is the defect #280 fixed one tab over; see the note on
  // `Benchmark.tsx` for why this one was left as it is.)
  benchmark: { kind: 'unavailable', reason: 'no_month', mappedShareBp: null },
  // Same reason, one step earlier: nothing was spent, so there is nothing to split. This
  // one *does* draw a box, because its tab has nothing else on it (#280).
