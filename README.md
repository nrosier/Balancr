...
<p align="center">
  ...
  <a href="https://github.com/nrosier/Balancr/releases"><img alt="Release" src="https://img.shields.io/badge/release-v2.0.2-blue"></a>
...
**Where it is now** — `2.0.2` is the current release, small fixes and dev-only
...
`docker pull` now resolves `latest` to `2.0.2`; a release candidate is
